...
xlabel('Time [h]'); ylabel('Terminal Voltage [V]'); title('Voltage - OCV'); grid minor
legend('exp', 'sim')

% Plot Voltage error
figure
plot(Batt.Time/3600, Batt.errV*1000);
xlabel('Time [h]'); ylabel('Error [mV]'); title('Voltage Error - OCV'); grid minor
