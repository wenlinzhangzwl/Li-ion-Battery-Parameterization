...
load('C:\Users\Wenlin\OneDrive\SCHOOL\48V Battery Pack Design\Test Results\1 - Characterization test 1\12-11-20_08.01 1336_Charge3_HPPC.mat');
...
xlabel('Time [h]'); ylabel('Terminal Voltage [V]'); title('Voltage - HPPC'); grid minor
legend('exp', 'sim')

% Plot Voltage error
figure
plot(Batt.Time/3600, Batt.errV*1000);
xlabel('Time [h]'); ylabel('Error [mV]'); title('Voltage Error - HPPC'); grid minor
